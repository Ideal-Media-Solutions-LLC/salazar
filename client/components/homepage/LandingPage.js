    ...
    <div>
      <header>
        <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-light">
          <a className="navbar-brand" href="#">Salazar</a>
              ...
              <div className="carousel-item active">
                ...
                <div className="container">
                  <div className="carousel-caption text-left">
                    <h1>Salazar language School</h1>
                    <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.Donec id elit non mi porta gravida at eget metus.Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                    <p><a className="btn btn-lg btn-primary" onClick={handleSignInWithGoogle} role="button">Start your journey</a></p>
                  </div>
                </div>
              </div>
          ...
          <div className="container marketing">
            ...
            <div className="row featurette">
              <div className="col-md-7">
                <h2 className="featurette-heading">Chat with Translations.<span className="text-muted">It'll blow your mind.</span></h2>
            ...
            <div className="row featurette">
              <div className="col-md-7 order-md-2">
                <h2 className="featurette-heading">Video with people around world. <span className="text-muted">See for yourself.</span></h2>
                <p className="lead">Donec ullamcorper nulla non metus auctor fringilla.Vestibulum id ligula porta felis euismod semper.Praesent commodo cursus magna, vel scelerisque nisl consectetur.Fusce dapibus, tellus ac cursus commodo.</p>
              </div>
            ...
            <div className="row featurette">
              <div className="col-md-7">
                <h2 className="featurette-heading">Learn new language any time anywhere.<span className="text-muted">Checkmate.</span></h2>
                <p className="lead">Donec ullamcorper nulla non metus auctor fringilla.Vestibulum id ligula porta felis euismod semper.Praesent commodo cursus magna, vel scelerisque nisl consectetur.Fusce dapibus, tellus ac cursus commodo.</p>
              </div>
              <div className="col-md-5">
