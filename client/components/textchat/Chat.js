...
const Chat = () => {
  ...
  const getContacts =() => {
    ...
    axios.get(`https://localhost:${port}/chatUsers`, {params: {user_ID: user.uid}})
    .then((response) => {
  ...
  const getMessages = (receiverId, senderId) => {
    axios.get(`https://localhost:${port}/chat`, {params: {user_ID: senderId, other_ID: receiverId}})
    .then((response) => {
  ...
  const handleMessageSubmit = () => {
    ...
    axios.post(`https://localhost:${port}/chat`, {messageToSend})
    .then((response) => {
  ...
  const handleTranslateButtonClick = (event) => {
    ...
    axios.get(`https://localhost:${port}/chat/translation`, {params: {language: language, user_ID: user.uid, other_ID: receiverId}})
    .then((response) => {
