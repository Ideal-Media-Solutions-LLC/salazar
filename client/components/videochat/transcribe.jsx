        ...
        <tbody className='Vright'>
          <div >
            ...
            <tr>
              ...
              <td >
                <select defaultValue="en-US" onChange={onChangeLanguageInput}>
            ...
            <tr>
              <td >Translation:</td>
              <td>
                <select defaultValue="Microsoft Server Speech Text to Speech Voice (de-DE, Hedda)" onChange={onChangeLanguageTarget}>
