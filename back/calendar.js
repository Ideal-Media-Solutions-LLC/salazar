...
const redirect_uris = ["urn:ietf:wg:oauth:2.0:oob","http://35.84.224.138","https://salazar-1ee6b.firebaseapp.com/__/auth/handler"];
...
function createEvent(schedule, callback, userToken) {
  ...
  function createVideoUrl() {
    let baseUrl = "http://35.84.224.138:3000/videochat/";
    var length = 20;
    var result           = '';
